...
# print(
#     "The numbers in this Python notebook become unreliable for output errors smaller than 10^(-13)"
# )
# print(
#     "due to the limit of machine-precision numbers. In principle, it is possible to implement"
# )
# print(
#     "arbitrary-precision arithmetic with complex numbers in Python, but it is a bit of a hassle."
# )
# print(
#     "This work was originally done in Mathematica, which natively supports arbitrary-precision arithmetic."
# )
